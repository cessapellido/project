...
<head>
   ...
   <title>Checkout | Iwata Appliances</title>
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" required placeholder="e.g. Sta. Cruz">
         </div>
         <div class="inputBox">
            <span>country :</span>
         ...
         <div class="inputBox">
            <span>pin code :</span>
            <input type="number" min="0" name="pin_code" required placeholder="e.g. 1014">
         </div>
      </div>
